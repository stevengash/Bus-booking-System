...
<body>
    ...
    <header>
        <nav>
            <div>
                    <a href="#" class="nav-item nav-logo">DEKUT BUS</a>
    ...
    <section id="home">
        <div id="route-search-form">
            <h1>Dekut Bus Ticket Booking System</h1>

            <p class="text-center">Welcome to Dekut Bus Ticket Booking System. Login now to manage bus tickets and much more. OR, simply scroll down to check the Ticket status using Passenger Record </p>
    ...
    <div id="block">
        ...
        <section id="about">
            <div>
                <h1>About Us</h1>
                <h4>Wanna know more about Dekut?</h4>
                <p>
                    Dekut is a shortform for Dedan Kimathi University of Technology. Its located in Central Kenya part of the country. 
                    Dekut is a school of higher learning which is the most preffered university not only in Kenya but also in Africa.
                    We beleive that Education is not only a key to success but also the fuel to Excelence.
                </p>
            </div>
        </section>
        <section id="contact">
        ...
        <footer>
        <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> - Dekut Bus Booking System | Made by Stephen Ng'ang'a
                        </p>
        </footer>
    </div>
